...
public class PasInterfaceDeclStubImpl extends PasStructStubImpl<PascalInterfaceDecl> implements PasInterfaceDeclStub {
    public PasInterfaceDeclStubImpl(StubElement parent, String name, List<String> parentNames, List<String> aliases,
                                    PasInterfaceDeclStubElementType stubElementType) {
