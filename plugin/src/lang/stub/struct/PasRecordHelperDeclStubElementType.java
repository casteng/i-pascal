...
public class PasRecordHelperDeclStubElementType extends PasStructDeclStubElementType<PasRecordHelperDeclStub, PascalRecordHelperDecl> {
    ...
    public PasRecordHelperDeclStub createStub(LighterAST tree, LighterASTNode node, StubElement parentStub) {
        return new PasRecordHelperDeclStubImpl(parentStub, "-", ".", false, Collections.emptyList(), null, INSTANCE);
    }
    ...
    public PasRecordHelperDeclStub createStub(@NotNull PascalRecordHelperDecl psi, StubElement parentStub) {
        ...
        return new PasRecordHelperDeclStubImpl(parentStub, stubName, psi.getContainingUnitName(), psi.isLocal(), psi.getParentNames(), aliases, INSTANCE);
    }

    @Override
    protected PasRecordHelperDeclStub createStub(StubElement parentStub, String name, String containingUnitName, boolean local,
                                                 List<String> parentNames, List<String> aliases) {
        return new PasRecordHelperDeclStubImpl(parentStub, name, containingUnitName, local, parentNames, aliases, INSTANCE);
    }
