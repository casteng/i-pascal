...
public class FPCSdkType extends BasePascalSdkType {
    ...
    private static final List<String> DEFAULT_SDK_LOCATIONS_UNIX = Arrays.asList("/usr/lib/codetyphon/fpc/fpc32", "/usr/lib/codetyphon/fpc", "/usr/lib/fpc", "/usr/share/fpc", "/usr/local/lib/fpc");
