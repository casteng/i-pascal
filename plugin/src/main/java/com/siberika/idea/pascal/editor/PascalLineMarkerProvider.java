...
public class PascalLineMarkerProvider implements LineMarkerProvider {
    ...
    @Override
    public void collectSlowLineMarkers(@NotNull final List<? extends PsiElement> elements, @NotNull final Collection<? super LineMarkerInfo<?>> result) {
        for (PsiElement element : elements) {
            if ((element instanceof PascalRoutine) ||
                (element instanceof PascalStructType) ||
                (element instanceof PasUsesClause) ||
                (element instanceof PasUnitModuleHead)) {
