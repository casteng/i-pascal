...
public class PasClassHelperDeclImpl extends PascalClassHelperDeclImpl implements PasClassHelperDecl {

  public PasClassHelperDeclImpl(ASTNode node) {
    super(node);
  }

  public PasClassHelperDeclImpl(PasHelperDeclStub stub, IStubElementType type) {
    super(stub, type);
  }

  public void accept(@NotNull PasVisitor visitor) {
    visitor.visitClassHelperDecl(this);
  }
