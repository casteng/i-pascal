...
public class PasRefNamedIdentImpl extends PascalNamedElementImpl implements PasRefNamedIdent {

  public PasRefNamedIdentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PasVisitor visitor) {
    visitor.visitRefNamedIdent(this);
  }
