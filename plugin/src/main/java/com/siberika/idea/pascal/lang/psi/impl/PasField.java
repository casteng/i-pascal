...
public class PasField {
    ...
    public static final ValueType ARRAY = new ValueType(null, Kind.ARRAY, null, null);
    public static final ValueType TYPEREF = new ValueType(null, Kind.TYPEREF, null, null);
    public static final ValueType TYPEALIAS = new ValueType(null, Kind.TYPEALIAS, null, null);
