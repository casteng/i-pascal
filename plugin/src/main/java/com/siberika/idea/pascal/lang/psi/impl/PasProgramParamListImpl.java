...
public class PasProgramParamListImpl extends PascalPsiElementImpl implements PasProgramParamList {

  public PasProgramParamListImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PasVisitor visitor) {
    visitor.visitProgramParamList(this);
  }
