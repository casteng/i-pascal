...
public class PasHighlightBreakOutsHandler extends HighlightUsagesHandlerBase<PsiElement> {
    ...
    @Override
    protected void selectTargets(@NotNull final List<? extends PsiElement> targets, @NotNull final Consumer<? super List<? extends PsiElement>> selectionConsumer) {
        selectionConsumer.consume(targets);
    }

    @Override
    public void computeUsages(@NotNull final List<? extends PsiElement> targets) {
