...
public class PasBlockGlobalImpl extends PascalPsiElementImpl implements PasBlockGlobal {

  public PasBlockGlobalImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PasVisitor visitor) {
    visitor.visitBlockGlobal(this);
  }
